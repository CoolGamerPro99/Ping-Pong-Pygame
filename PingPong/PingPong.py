...
reset_button = pygame.Rect(screen.get_width()/2 - 120, screen.get_height()/2 - 10, 210, 60)
...
def main_menu():
    ...
    while True:
        ...
        # Draw more stuff
        draw_text("Play", basic_font, accent_color, start_button,
                  screen.get_width()/2 - 50, screen.get_height()/2 - 145)
        draw_text("Exit", basic_font, accent_color, exit_button,
                  screen.get_width()/2 - 50, screen.get_height()/2 + 165)
        draw_text("Settings", basic_font, accent_color, options_button,
...
def pause_menu():
    ...
    while True:
        ...
        # Draw more stuff
        draw_text("Resume", basic_font, accent_color, resume_button,
                  screen.get_width()/2 - 70, screen.get_height()/2 - 145)
        draw_text("Back to Menu", basic_font, accent_color, main_menu_button,
                  screen.get_width()/2 - 120, screen.get_height()/2 + 200)
        draw_text("Settings", basic_font, accent_color, options_button,
                  screen.get_width()/2 - 70, screen.get_height()/2 + 10)
...
def settings_menu():
    ...
    while True:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if click == True:
                    ...
                    if pygame.Rect.collidepoint(start_music_button, pygame.mouse.get_pos()):
                        pygame.mixer_music.play(-1)
                    if pygame.Rect.collidepoint(reset_button, pygame.mouse.get_pos()):
        ...
        if screen.get_width()/2 - 120 + 210 > pygame.mouse.get_pos()[0] > screen.get_width()/2 - 120 and screen.get_height()/2 - 10 + 60 > pygame.mouse.get_pos()[1] > screen.get_height()/2 - 10:
            pygame.draw.rect(screen, red_accent, reset_button)

        # Draw more stuff
        draw_text("Back", basic_font, accent_color, main_menu_button,
                  screen.get_width()/2 - 65, screen.get_height()/2 + 195)
        draw_text("Stop Music", basic_font, accent_color, stop_music_button,
                  screen.get_width()/2 - 250, screen.get_height()/2 - 130)
        draw_text("Start Music", basic_font, accent_color, start_music_button,
                  screen.get_width()/2, screen.get_height()/2 - 130)
        draw_text("Reset", basic_font, accent_color, reset_button,
                  screen.get_width()/2 - 60, screen.get_height()/2)
...
def pause_settings_menu():
    ...
    while True:
        ...
        # Draw more stuff
        draw_text("Back", basic_font, accent_color, back_pause_button,
                  screen.get_width()/2 - 70, screen.get_height()/2 + 195)
        draw_text("Stop Music", basic_font, accent_color, stop_music_button,
                  screen.get_width()/2 - 250, screen.get_height()/2 - 130)
        draw_text("Start Music", basic_font, accent_color, start_music_button,
                  screen.get_width()/2, screen.get_height()/2 - 130)
